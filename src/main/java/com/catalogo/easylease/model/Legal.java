...
public class Legal {
	...
	/**
	 * @return the precioFinanciado
	 */
	public String getPrecioFinanciado() {
		return precioFinanciado;
	}

	/**
	 * @param precioFinanciado the precioFinanciado to set
	 */
	public void setPrecioFinanciado(String precioFinanciado) {
		this.precioFinanciado = precioFinanciado;
	}
	...
	/**
	 * @return the fechaValidezOferta
	 */
	public String getFechaValidezOferta() {
		return fechaValidezOferta;
	}

	/**
	 * @param fechaValidezOferta the fechaValidezOferta to set
	 */
	public void setFechaValidezOferta(String fechaValidezOferta) {
		this.fechaValidezOferta = fechaValidezOferta;
	}

	/**
	 * @return the precioAlContado
	 */
	public String getPrecioAlContado() {
		return precioAlContado;
	}

	/**
	 * @param precioAlContado the precioAlContado to set
	 */
	public void setPrecioAlContado(String precioAlContado) {
		this.precioAlContado = precioAlContado;
	}
